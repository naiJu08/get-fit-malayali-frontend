...
const ThemeSwitcher: React.FC = () => {
  const { isDark, setIsDark, clearIsDark } = useThemeStore()
  ...
  return (
    <div>
      <label className="theme_switch cursor-pointer">
        <input
          className="theme_switch__input cursor-pointer"
          type="checkbox"
          role="switch"
          checked={isDark}
        ...
        />
        <svg
          className="theme_switch__icon switch__icon--light"
          viewBox="0 0 12 12"
          width="12px"
          height="12px"
          aria-hidden="true"
        ...
        <svg
          className="theme_switch__icon theme_switch__icon--dark"
          viewBox="0 0 12 12"
          width="12px"
          height="12px"
          aria-hidden="true"
        ...
        <span className="theme_switch__sr">Dark Mode</span>
      </label>
    </div>
  )
}
