...
export function ClientWorkflowDetails({
  ...
  if (isSubscribed) {
    return (
      <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-50/90 via-teal-50/40 to-slate-50 border border-emerald-200/80 shadow-2xs transition-all">
        <div className="flex items-center gap-2.5 min-w-0 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap min-w-0">
            ...
            <span className="text-xs font-bold text-gray-900 truncate">
              {toTitleCaseStr(planName) || 'General Wellness'}
            </span>
            {category && (
