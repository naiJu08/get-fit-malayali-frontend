...
export default function Notifications() {
  ...
  const [adminSection, setAdminSection] = useState<'inbox' | 'broadcast'>(
    'inbox'
  )
  ...
  return (
    <div className="w-full">
      <div className="px-6 pt-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <div className="flex space-x-4">
          <button
            type="button"
            onClick={() => setAdminSection('inbox')}
                    ...
                    <SmartTable
                      ...
                      paginationProps={{
                        ...
                        totalPages: Math.max(
                          1,
                          Math.ceil(
                            historyTable.total / historyPagination.per_page
                          )
                        ),
                        dropOptions: [10, 20, 30, 50, 100],
                      }}
